-- =============================================
-- BASE DE NCMs ESPECIALIZADA EM PIZZARIA/DF
-- Dados reais de NCM + alíquotas para Brasília
-- =============================================

-- Limpar NCMs genéricos e inserir base especializada
TRUNCATE TABLE ncm CASCADE;

-- QUEIJOS (principal insumo de pizzaria)
...
-- =============================================
-- PRONTO! 70+ NCMs especializados em pizzaria
-- =============================================
